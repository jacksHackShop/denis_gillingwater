...
function book_gallery() { 
	...
	register_post_type( 'book_gallery', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Book Galleries', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Book Gallery', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Book Galleries', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Book Gallery', 'bonestheme' ), /* Add New Display Title */
			...
			'description' => __( 'This is a Book Gallery', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'book_gallery', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'book_gallery', /* you can rename the slug here */
	...
	add_action( 'init', 'book_gallery');


// let's create the function for the custom type
function context_gallery() { 
	// creating (registering) the custom type 
	register_post_type( 'context_gallery', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Context Galleries', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Context Gallery', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Context Galleries', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Context Gallery', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Galleries', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Gallery', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Gallery', 'bonestheme' ), /* View Display Title */
			...
			'description' => __( 'This is a Context Gallery', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			'publicly_queryable' => true,
			'exclude_from_search' => false,
			'show_ui' => true,
			...
			'menu_position' => 8, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-icon.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'context_gallery', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'context_gallery', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
	...
	// adding the function to the Wordpress init
	add_action( 'init', 'context_gallery');
	/*
	...
	*/
	...
	register_taxonomy( 'custom_cat', 
		array('book_gallery'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
